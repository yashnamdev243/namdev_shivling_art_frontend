    ...
    >
      ...
      <div className="relative overflow-hidden bg-[#1C1A17] px-7 pb-9 pt-7 text-center text-white">
        ...
        <div className="relative mx-auto flex h-[64px] w-[64px] items-center justify-center rounded-2xl border border-[#D4AF6A]/30 bg-[#D4AF6A]/[0.08]">
          <LockOutlined className="text-[26px] text-[#D4AF6A]" />
        </div>
      ...
      {/* Body */}
      <div className="bg-[#FAF8F3] px-7 pb-7 pt-6 sm:px-8">
        <form onSubmit={submit} className="space-y-4">
          <div>
            ...
            <Input
              size="large"
              prefix={<MailOutlined className="mr-1 text-[#A8823C]/70" />}
              type="email"
              value={email}
              onChange={(e) => setEmail(e.target.value)}
              placeholder="you@example.com"
              autoComplete="email"
              className="!h-12 !rounded-2xl !border-[#1C1A17]/10 !bg-white hover:!border-[#A8823C]/40 focus-within:!border-[#A8823C]/60 focus-within:!shadow-[0_0_0_3px_rgba(168,130,60,0.12)]"
            />
          </div>
          ...
          <div>
            ...
            <Input.Password
              size="large"
              prefix={<LockOutlined className="mr-1 text-[#A8823C]/70" />}
              value={password}
              onChange={(e) => setPassword(e.target.value)}
              placeholder="Enter your password"
              autoComplete="current-password"
          ...
          //  type="primary"
            ...
            block
            size="large"
            className="!mt-2 !h-12 !rounded-2xl !border-0 !bg-[#1C1A17] !font-medium !shadow-none transition-all duration-200 hover:!-translate-y-0.5 hover:!bg-[#2A2620] !text-[#D4AF6A]"
          >
            <span className="flex items-center justify-center gap-2">
              {loading ? "Signing in…" : "Login"}
        ...
        <Link
          to="/register"
         state={{ from, backgroundLocation }}
          className="mt-4 flex items-center justify-center gap-2 rounded-2xl border border-[#D4AF6A]/30 bg-[#A8823C]/[0.05] py-3 text-sm font-medium text-[#A8823C] transition-colors duration-200 hover:border-[#A8823C]/50 hover:bg-[#A8823C]/[0.08]"
        >
          Create a new account
        </Link>
      </div>
