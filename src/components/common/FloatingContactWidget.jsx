        ...
        >
          ...
          <AnimatePresence>
            <motion.button
              ...
              onClick={scrollToTop}
              aria-label={t.scrollTop}
              className="flex h-10 w-10 items-center justify-center rounded-full border border-[#1C1A17]/10 bg-[#FBF7EF]/90 text-[#1C1A17] shadow-[0_8px_20px_rgba(28,26,23,0.12)] backdrop-blur-md transition-colors duration-200 hover:border-[#A8823C]/50 hover:text-[#A8823C] sm:h-11 sm:w-11"
            >
              <ArrowUpOutlined aria-hidden="true" />
            </motion.button>
          </AnimatePresence>
          ...
          <AnimatePresence>
            {expanded && (
              ...
              >
                <Link
                  to="/contact"
                  className="flex items-center gap-2 rounded-full border border-[#1C1A17]/10 bg-[#FBF7EF]/95 px-4 py-2.5 text-sm font-medium text-[#1C1A17] shadow-[0_8px_24px_rgba(28,26,23,0.14)] backdrop-blur-md transition-all duration-200 hover:border-[#A8823C]/40 hover:shadow-[0_10px_28px_rgba(28,26,23,0.18)]"
                >
                  <CalendarOutlined className="text-[#A8823C]" aria-hidden="true" />
                  {t.bookConsultation}
                </Link>
              </motion.div>
            )}
          ...
          <div className="relative">
            {!reduceMotion && (
              <span className="absolute inset-0 -z-10 animate-ping rounded-full bg-emerald-500/25" />
            )}
            <motion.a
              href={SITE.social.whatsapp}
              target="_blank"
              ...
              onBlur={() => setExpanded(false)}
              onClick={() => setExpanded(false)}
              className="flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-[#123524] to-[#1A4A33] text-2xl !text-[#F2E3C8] shadow-[0_15px_35px_rgba(18,53,36,0.45)] sm:h-16 sm:w-16"
            >
              <WhatsAppOutlined aria-hidden="true" />
            </motion.a>
          </div>
