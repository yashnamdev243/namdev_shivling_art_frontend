export default function StatCard({
  ...
  return (
    ...
    // inside StatCard.jsx, add prop `highlight`
    <div
      className={`rounded-2xl border ${highlight ? "border-red-300 ring-2 ring-red-100" : "border-orange-100"} bg-white p-5 shadow-sm ...`}
    >
