...
//   const absoluteUrl =
//     typeof window !== "undefined" ? `${window.location.origin}${detailsUrl}` : detailsUrl;
...
//   return (
//     <motion.div whileHover={{ y: -8 }} transition={{ duration: 0.35 }} className="h-full">
//       <div className="group flex h-full flex-col overflow-hidden rounded-[22px] border border-stone-200 shadow-md transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_50px_rgba(249,115,22,.18)] sm:rounded-[28px]">
//         {/* Image */}
//         <div className="relative">
//           <Link to={detailsUrl} aria-label={product?.name}>
//             <div className="relative h-48 overflow-hidden sm:h-72">
//               <img
//                 src={image}
//                 alt={product?.name}
...
//           {/* Wishlist + Share overlay — always visible on touch devices,
//               fades in on hover for pointer devices via group-hover. */}
//           <div className="absolute bottom-3 right-3 flex flex-col gap-2 opacity-100 transition sm:opacity-0 sm:group-hover:opacity-100">
//             <button
//               type="button"
//               onClick={handleWishlist}
//               aria-label={wishlisted ? "Remove from wishlist" : "Add to wishlist"}
//               aria-pressed={wishlisted}
//               className="flex h-9 w-9 items-center justify-center rounded-full bg-white/90 shadow backdrop-blur transition hover:scale-110 sm:h-10 sm:w-10"
//             >
//               {wishlisted ? (
//                 <HeartFilled className="text-red-500" aria-hidden="true" />
//               ) : (
//                 <HeartOutlined className="text-slate-700" aria-hidden="true" />
//               )}
//             </button>
...
//             {/* Product Name — the whole card links to details, so this is
//                 a single link rather than nesting a second anchor inside it
//                 (an <a> inside an <a> is invalid HTML and breaks clicks). */}
//             <Link to={detailsUrl} className="block min-h-[64px] sm:min-h-[72px]">
//               <Tooltip title={product?.name}>
//                 <h3 className="line-clamp-2 min-h-[36px] text-base font-bold leading-6 tracking-tight text-slate-900 transition-all duration-300 group-hover:text-orange-600 sm:min-h-[40px] sm:text-lg">
//                   {product?.name}
//                 </h3>
...
//               className="group flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-green-500 to-green-600 text-white transition duration-300 hover:-translate-y-1 hover:shadow-lg sm:h-12 sm:w-12"
//             >
//               <WhatsAppOutlined className="text-lg transition group-hover:scale-110 sm:text-xl" aria-hidden="true" />
//             </a>

//             <Link
//               to={detailsUrl}
//               className="group flex flex-1 items-center justify-center gap-1.5 rounded-xl border border-orange-200 bg-orange-50 py-2.5 text-xs font-semibold text-orange-600 transition-all duration-300 hover:border-orange-500 hover:bg-gradient-to-r hover:from-orange-500 hover:to-amber-500 hover:text-white hover:shadow-xl sm:gap-2 sm:text-sm"
//             >
//               View Details
//               <ArrowRightOutlined className="transition group-hover:translate-x-1" aria-hidden="true" />
//             </Link>
...
//               className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-orange-500 to-amber-500 text-white transition duration-300 hover:-translate-y-1 hover:shadow-lg disabled:cursor-not-allowed disabled:opacity-40 disabled:hover:translate-y-0 disabled:hover:shadow-none sm:h-12 sm:w-12"
//             >
//               <ShoppingCartOutlined className="text-lg sm:text-xl" aria-hidden="true" />
//             </button>
//           </div>
//         </div>
//       </div>
...
import { Link } from "react-router-dom";
import { motion } from "framer-motion";
import { WhatsAppOutlined, ArrowRightOutlined, HeartFilled, HeartOutlined } from "@ant-design/icons";
import { Tooltip } from "antd";
